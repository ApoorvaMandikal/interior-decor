  ...
  return (
    <div className="container mx-auto md:ml-0 ml-[7%] lg:px-0">
          ...
          >
            <div className="bg-[#FAF4EF] py-6 px-6 h-full rounded-bl-[4rem]">
              <div className="flex flex-col justify-between h-[120%] ">
                <div
                  className="flex flex-col px-5 py-5 text-start"
      ...
      <div className="md:hidden">
        <div
          ref={containerRef}
          className="carousel-container relative overflow-x-auto overflow-y-hidden whitespace-nowrap w-full scroll-smooth"
        ...
        >
          {items.map((item, index) => (
            <div
              ...
              style={{ transform: calculateTranslation(index) }}
            >
              <div className="bg-[#FAF4EF] py-6 px-6 h-[85%] sm:h-[60%] rounded-bl-[4rem]">
                <div className="flex flex-col justify-between h-[120%] sm:h-[120%]">
                  <div
                  ...
                  <img
                    src={item.image}
                    alt={`Item ${index}`}
                    className=" w-80 h-[22rem] sm:h-[22rem] mb-2"
                  />
                </div>
              </div>
            </div>
